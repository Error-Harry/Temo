...
const DiscountValue = () => {
  ...
  const [effect, setEffect] = useState("addMissing");

  const handleSubmit = () => {
    // Example of using a DOM property to change focus
    // if (inputRef.current) {
    //   console.log('Input value before submitting:', inputRef.current.value);
      ...
      <div className="container">
        <div className="horizontal-container">
          <div
            className="box"
            onClick={() =>
              setVisibleSection(visibleSection === "order" ? "" : "order")
            }
          >
          ...
          <div
            className="box"
            onClick={() =>
              setVisibleSection(visibleSection === "rewards" ? "" : "rewards")
            }
          >
            <h3>Rewards</h3>
          </div>
          ...
          <div
            className="box"
            onClick={() =>
              setVisibleSection(visibleSection === "shipping" ? "" : "shipping")
            }
          >
            <h3>Free Shipping</h3>
          </div> */}
        ...
        <div className="content-container">
          ...
          {/* {visibleSection === "products" && (
            <div className="content-box">
              ...
              >
                <option value="amount">
                  Amount discount: Apply to item subtotal
                </option>
                <option value="percent">
              ...
              <label>
                <input
                  ...
                  onChange={() =>
                    setApplyToAllOrderLines(!applyToAllOrderLines)
                  }
                />
              ...
              {excludedProducts.map((excludedProduct, index) => (
                <div key={index}>
                  <input
                    ...
                    onChange={(e) =>
                      handleExcludedProductChange(index, e.target.value)
                    }
                    placeholder="Excluded Product"
                  />
                </div>
              ))}
              <button type="button" onClick={addExcludedProductField}>
                + Add Another
              </button>
            </div>
          )} */}
          ...
          {/* {visibleSection === "rewards" && (
            <div className="content-box">
              ...
              >
                <option value="amount">
                  Free products: Add missing order items to match total discount
                  units count
                </option>
                <option value="percent">
              ...
              {discountType === "many" && (
                <>
                  ...
                  >
                    <option value="addMissing">
                      Add missing order items to match total discount units
                      count
                    </option>
                    <option value="alwaysAdd">
          ...
          {visibleSection === "shipping" && (
            <div className="content-box">
              ...
              <h4>Shipping</h4>
              <input type="text" value="Free Shipping" readOnly />
